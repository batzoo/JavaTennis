...
public class Set extends Jeu {
     ...
     */
    public Joueur vainqueur_set_final(Joueur j1,Joueur j2,boolean auto,boolean affich){
       this.jeuxJ1=0;
       this.jeuxJ2=0;
       Joueur c;
   ...
   public Joueur vainqueur_set(Joueur j1,Joueur j2,boolean auto,boolean affich) {
       //Joueur tampon
       Joueur a;
       ...
       while(this.jeuxJ1<6 &&this.jeuxJ2<6&&!(this.jeuxJ1==5&&this.jeuxJ2==5)){
        ...
        //en cas de 5-5, on appella fonction jeux_decart_H
           ...
           return jeux_decart(j1,j2,auto,affich);
    ...
    */
   public Joueur jeux_decart(Joueur j1,Joueur j2,boolean auto,boolean affich) {
       Joueur a;
    ...
    */
   public Joueur tiebreak(Joueur j1,Joueur j2,boolean auto,boolean affich) {
       int a=0;
       int b=0;
       Joueur c;
